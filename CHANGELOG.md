...
- Identity card opens the same reputation ledger (user/merchant/enterprise); card payload includes `reputation`; buyers and sellers both accrue on genuine settles.
