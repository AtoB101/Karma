...
| 5 | KarmaTaskManager 任务状态机 | `core/schemas.py` + `core/settlement/engine.py` + `api/routes/settlement.py` | 已落地（含非法迁移守卫） |
...
| 10 | API / MCP / Agent Runtime 基础适配器 | `sdk/adapters.py` | 本次补齐 |
