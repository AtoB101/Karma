...
class PostgresSettlementStore(SettlementStore):
    ...
    def _to_row(s: SettlementState) -> dict:
        return {
            ...
            "worker_profile_id": getattr(s, "worker_profile_id", None),
            ...
            "onchain_binding_id":       getattr(s, "onchain_binding_id", None),
            "onchain_buyer_bill_id":    getattr(s, "onchain_buyer_bill_id", None),
            "onchain_agent_bill_id":    getattr(s, "onchain_agent_bill_id", None),
    ...
    def _from_row(row: SettlementModel) -> SettlementState:
        return SettlementState(
            ...
            worker_profile_id=getattr(row, "worker_profile_id", None),
            ...
            onchain_buyer_bill_id=getattr(row, "onchain_buyer_bill_id", None),
            onchain_agent_bill_id=getattr(row, "onchain_agent_bill_id", None),
