...
grep -q 'runtime_key_call_log' "$ROOT/db/migrations/versions/0050_runtime_key_call_log_and_notices.py"
grep -q 'console_notices' "$ROOT/db/migrations/versions/0050_runtime_key_call_log_and_notices.py"
